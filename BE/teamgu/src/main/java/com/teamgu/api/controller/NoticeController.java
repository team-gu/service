...
public class NoticeController {
    ...
    public ResponseEntity<? extends BasicResponse> getNoticeDetail(@PathVariable @ApiParam(value = "공지사항의 id", required = true) long id) {
    ...
    public ResponseEntity<? extends BasicResponse> deleteNotice(@PathVariable @ApiParam(value = "공지사항의 id", required = true) long id) {
